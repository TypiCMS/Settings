...
class SettingsSeeder extends Seeder
{
    public function run()
    {
        ...
        $typi_settings = [
            ...
            ['id' => 6, 'group_name' => 'nl', 'key_name' => 'status', 'value' => '1', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['id' => 7, 'group_name' => 'en', 'key_name' => 'website_title', 'value' => 'Untitled website', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['id' => 8, 'group_name' => 'en', 'key_name' => 'status', 'value' => '1', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['id' => 9, 'group_name' => 'config', 'key_name' => 'welcome_message', 'value' => 'Welcome to the administration panel of TypiCMS.', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['id' => 10, 'group_name' => 'config', 'key_name' => 'auth_public', 'value' => 0, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['id' => 11, 'group_name' => 'config', 'key_name' => 'register', 'value' => 0, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
